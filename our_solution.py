...
class KeyboardPlayerPyGame(Player):
    def __init__(self):
        ...
        self.database = None
        self.goal = None # NOTE: goal is the image, not the map position, which is a separate variable
        ...
        # NOTE: might need some driving correction heuristics based on vanishing points
